            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">{{ __('Students') }}</span>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            <a href="{{ route('admin.students') }}" class="side-menu__item">{{ __('Students') }}
                            </a>
                        </li>
                        <li class="slide">
                            <a href="javascript:void(0);" class="side-menu__item">{{ __('Add Student') }}</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
